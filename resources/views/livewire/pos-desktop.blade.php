<div class="flex flex-row h-screen antialiased text-blue-gray-800">
    @if($isModalOpen)
        @include('livewire.pos-choose-customer')
    @endif
    <!-- left sidebar -->
            ...
            <ul class="flex flex-col space-y-2 mt-12">
                <li>
                    <a href="#" class="flex items-center">
                        <span class="flex items-center justify-center h-12 w-12 rounded-2xl" class="hover:bg-cyan-400 text-cyan-100">
    ...
    <div class="flex-grow flex">
        ...
        <div class="flex flex-col bg-blue-gray-50 h-full w-full py-4">
            <div class="h-full overflow-hidden mt-4">
                <div class="h-full overflow-y-auto px-2">
                    ...
                    @else
                    <div class="grid grid-cols-5 gap-5 pb-3">
        ...
        <!-- right sidebar -->
        <div class="w-2/5 flex flex-col bg-blue-gray-50 h-full bg-white pr-4 pl-2 py-4">
                ...
                <div class="flex-1 flex flex-col overflow-auto">
                    <div class="h-16 text-center flex justify-center">
                        ...
                        <div class="flex-grow px-8 text-right text-lg py-4 relative">
                            <button wire:click="addCustomer()" class="text-blue-gray-300 hover:text-pink-500 focus:outline-none">
